...
public class Test {
	...
	public static final int BR_NAJVISEG_TESTA = 10;	
	public static final String prvi_dio = "D:\\Users\\Robert\\Downloads\\Jednostavnija inaƒica\\lab3\\testovi1/test"; // ako stavis testove u projekt onda je staza relativna
	...
	public static void main(String[] args) throws Exception {
		...
		for(int i = 1; i <= BR_NAJVISEG_TESTA; i++){
			...
			argsum[0] = ""+i;
			try{
				SemantickiAnalizator.main(null);		//POZIVANJE main PROGRAMA KOJI RADITE
